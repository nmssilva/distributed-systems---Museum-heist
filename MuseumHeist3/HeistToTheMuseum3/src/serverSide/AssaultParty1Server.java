...
public class AssaultParty1Server {
    ...
    public static void main(String[] args) throws RemoteException {
        ...
        AssaultParty ap = new AssaultParty(1, museum, log);
        
        try {
            api = (APInterface) UnicastRemoteObject.exportObject(ap, RegistryConfig.REGISTRY_ASSAULT_PARTY_PORT+1);
        } catch (RemoteException e) {
            System.out.println("Excepção na geração do stub para o AP1: " + e.getMessage());
            System.exit(1);
        }

        System.out.println("O stub para o AP1 foi gerado!");
